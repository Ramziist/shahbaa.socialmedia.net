...
<div class="collapse navbar-collapse mr-4" id="navbar">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li>
                <a class="nav-link username-nav" href="profile.php?<?php echo "u_id=$userId"; ?>"><?php echo "$userFname $userLname"; ?></a>
            </li>    
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <button class="btn search-btn my-2 my-sm-0" type="submit" name="SearchUserBtn"><i class="fa fa-search" aria-hidden="true"></i></button>
        </form>
